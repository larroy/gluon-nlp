...
from mxnet.ndarray import square, power, sqrt, maximum, minimum, clip, where, lamb_update_phase1, lamb_update_phase2
...
class FP16Trainer:
    ...
    def step(self, batch_size, max_norm=None, num_ctxs=None, verbose=False):
        ...
        step_size = (batch_size * self._scaler.loss_scale).asscalar()
        if max_norm is not None:
            ...
            if int(os.environ.get('SKIP_GLOBAL_CLIP', False)):
                ...
                step_size = (ratio * step_size).asscalar()
